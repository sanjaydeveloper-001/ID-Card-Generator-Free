function SideTrash({ trash, setDesign }) {
  return (
        ...
        {trash.length > 0 ? (
          trash.map((proj, i) => (
            ...
            >
              ...
              {/* Omitted delete icon as per original */}
            </div>
          ))
        ) : (
          <div className="w-full px-2">
            <h1 className="text-[14px] sm:text-[15px] font-medium">No trash found ..!</h1>
          </div>
        )}
      </div>
    </div>
